...
flowchart TD
    ...
    M3_CekID -- Tidak --> M3_Err[/Cetak ID Tidak Ditemukan/] --> RetMenu
    ...
    M4_CekID -- Tidak --> M4_Err[/Cetak ID Tidak Ditemukan/] --> RetMenu
    M4_CekID -- Ya --> M4_Konfirm[/Konfirmasi y/n/]
    M4_Konfirm --> M4_CekY{Yakin 'y'?}
    M4_CekY -- Tidak --> M4_Batal[/Penghapusan Dibatalkan/] --> RetMenu
